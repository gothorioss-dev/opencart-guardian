...
class Catalog extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		if (
			...
			|| !$this->model_extension_gtr_guardian_other_gtr_guardian->isDomainEnabled('catalog')
		) {
		...
		$this->load->language('extension/gtr_guardian/guardian/catalog');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/gtr_guardian/guardian/catalog', 'user_token=' . $this->session->data['user_token'])
		];
		...
		$this->response->setOutput($this->load->view('extension/gtr_guardian/guardian/catalog', $data));
	}
}
