 ...
 */
class Storefront extends \Opencart\System\Engine\Controller {
	/**
	 * Index
	 *
	 * @return void
	...
	public function index(): void {
		...
		if (
			...
			|| !$this->model_extension_gtr_guardian_other_gtr_guardian->isDomainEnabled('storefront')
		) {
		...
		$this->load->language('extension/gtr_guardian/guardian/storefront');
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/gtr_guardian/guardian/storefront', 'user_token=' . $this->session->data['user_token'])
		];
		...
		$this->response->setOutput($this->load->view('extension/gtr_guardian/guardian/storefront', $data));
	}
}
